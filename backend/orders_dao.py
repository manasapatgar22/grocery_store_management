...
def get_order_details(connection, order_id):
    ...
    query = "SELECT order_detail.order_id, order_detail.quantity, order_detail.total_price, "\
            "products.name, products.price_per_unit FROM order_detail LEFT JOIN products on " \
            "order_detail.product_id = products.product_id where order_detail.order_id = %s"
